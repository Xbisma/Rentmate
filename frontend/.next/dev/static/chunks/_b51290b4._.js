...
"[project]/app/owner/maintenance/page.js [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function MaintenanceRequests() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "MaintenanceRequests.useEffect": ()=>{
            fetchRequests();
        }
    }["MaintenanceRequests.useEffect"], []);
    const fetchRequests = async ()=>{
        try {
            const data = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$maintenanceService$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getOwnerMaintenanceRequests"])();
            setRequests(data);
        } catch (err) {
    ...
    const updateStatus = async (id, newStatus)=>{
        try {
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$maintenanceService$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["updateMaintenanceRequestStatus"])(id, {
                status: newStatus
            });
            // Update local state
...
_s(MaintenanceRequests, "QF1hh5bDkbH2SrxdSLUn+Tho0H4=");
_c = MaintenanceRequests;
var _c;
__turbopack_context__.k.register(_c, "MaintenanceRequests");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
//# sourceMappingURL=_b51290b4._.js.map