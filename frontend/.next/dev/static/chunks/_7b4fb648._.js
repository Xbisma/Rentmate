...
function MaintenanceRequests() {
    ...
    const fetchRequests = async ()=>{
        try {
            const data = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$maintenanceService$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getMaintenanceRequests"])();
            setRequests(data);
        } catch (err) {
    ...
    const updateStatus = async (id, newStatus)=>{
        try {
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$maintenanceService$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["updateMaintenanceStatus"])(id, {
                status: newStatus
            });
            // Update local state
...
//# sourceMappingURL=_7b4fb648._.js.map